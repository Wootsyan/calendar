			...
			if (i<firstDayOfMonth) {
				if(!(i%7)){
					...
					contentHtmlNumbers += '<div class="daysOfMonth" id="square'+i+'"></div>';
								 ...
								 // Sprawdzania czy dzien nie jest po za miesiącem,
								 // jeżeli jest to, miesiąc się zmienia i drugi warunek się nie spełnia
								 // a to znaczy, że miesiąc nie ma już tylu dni
								 ...
								 if( ( dat.getDate() === (i+1-firstDayOfMonth) ) && (dat.getMonth() === month) ) {
									 ...
									 // dodatkowo zaznaczanie dni dzisiejszego
									        ...
									        if ( ( !(i%7) )  && ( (i+1-firstDayOfMonth) === currentNrDay ) ) {
